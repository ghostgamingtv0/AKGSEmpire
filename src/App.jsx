...
import { LayoutDashboard, Wallet, TrendingUp, Shield, Menu, X, Users, PlayCircle, Coins, Zap } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              type="button"
              onClick={onConnect}
              className="px-6 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white font-medium hover:bg-[#53FC18] hover:text-black hover:border-[#53FC18] transition-all duration-300 flex items-center gap-2"
            >
              <Wallet size={18} />
              Connect Wallet
            </button>
  ...
  return (
    <Router>
      <div className="min-h-screen flex flex-col font-sans selection:bg-[#53FC18] selection:text-black">
        <Navbar onConnect={() => setIsWalletModalOpen(true)} />
