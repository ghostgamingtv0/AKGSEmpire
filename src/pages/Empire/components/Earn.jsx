          ...
          <div className="glass-panel p-6 border border-white/10 flex flex-col items-center justify-center text-center relative overflow-hidden h-full">
            {gCode ? (
              <div className="animate-in fade-in zoom-in duration-500 w-full">
                ...
                <div className="bg-black/80 border border-[#53FC18] rounded-xl px-6 py-5 mb-3 shadow-inner shadow-[#53FC18]/10 relative overflow-hidden flex items-center justify-center">
