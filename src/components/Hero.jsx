    ...
    <div className="relative min-h-screen pt-20 pb-20 overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Vision Section */}
          <motion.div variants={itemVariants} className="max-w-5xl mx-auto mb-16 glass-panel p-1 rounded-3xl bg-gradient-to-b from-[#53FC18]/20 to-transparent relative overflow-hidden group">
            <div className="bg-[#050505]/90 backdrop-blur-xl rounded-[22px] p-8 md:p-12 border border-white/5 relative overflow-hidden">
                {/* Decorative Elements */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#53FC18]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 group-hover:bg-[#53FC18]/10 transition-colors duration-500"></div>
                <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#53FC18]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 group-hover:bg-[#53FC18]/10 transition-colors duration-500"></div>
                
                <div className="relative z-10 text-right" dir="rtl">
                  <h3 className="text-3xl font-bold text-[#53FC18] flex items-center gap-3 mb-6 justify-start">
                    <div className="p-2 rounded-lg bg-[#53FC18]/10">
                        <Globe size={28} />
                    </div>
                    الرؤية
                  </h3>
                  <p className="text-gray-100 leading-loose text-lg md:text-xl font-arabic pl-4 border-r-4 border-[#53FC18]/50 pr-6">
                    نحن نعيد صياغة قواعد صناعة المحتوى الرقمي. بدلاً من أن يكون المشاهد مجرد رقم إحصائي، نحوله إلى شريك حقيقي في النجاح. يمزج مشروعنا بين الترفيه والعوائد الحقيقية عبر نظام مشاركة أرباح قائم على الجدارة والاستحقاق، بعيداً عن الحظ.
                  </p>
                  
                  <div className="mt-8 pt-8 border-t border-white/10 text-left flex flex-col md:flex-row gap-6 items-start md:items-center" dir="ltr">
                     <div className="flex-1">
                         <h4 className="text-[#53FC18] font-bold text-sm mb-3 flex items-center gap-2 uppercase tracking-wider">
                            <Globe size={16} /> The Vision
                         </h4>
          ...
          {/* CTA Buttons */}
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8 relative z-20">
            <Link to="/earn" className="w-full sm:w-auto btn-primary flex items-center justify-center gap-3 group relative overflow-hidden">
              <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
              <Zap className="relative z-10 group-hover:fill-black transition-colors" size={20} />
            ...
            <motion.a 
              ...
              className="w-full sm:w-auto relative px-6 py-3 rounded-xl font-bold flex items-center justify-center gap-3 overflow-hidden group transition-all duration-300 border border-white/10 bg-white/5 hover:bg-[#53FC18]/10 hover:border-[#53FC18]/50 hover:shadow-[0_0_20px_rgba(83,252,24,0.15)]"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:animate-shimmer" />
              <FileText className="text-gray-400 group-hover:text-[#53FC18] transition-colors duration-300" size={20} />
